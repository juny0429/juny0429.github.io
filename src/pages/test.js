        ...
        <div className={projectStyle.projectMain}>
            <div className={projectStyle.projectContant}>
                <div className={projectStyle.projectIconPackage}>
                    <div className={projectStyle.IconBox}>
                        <img
                        ...
                        />
                        <p className={projectStyle.iconText}>single</p>
                    </div>
                    <div className={projectStyle.IconBox}>
                        <img 
                        ...
                        />
                        <p className={projectStyle.iconText}>Team</p>
                    </div>
                    <div className={projectStyle.IconBox}>
                    <img 
                    ...
                    />
                    <p className={projectStyle.iconText}>Game</p>
                    </div>
                    <div className={projectStyle.IconBox}>
                        <img 
                        ...
                        />
                        <p className={projectStyle.iconText}>Study</p>
                    </div>
                </div>
            </div>
        </div>
